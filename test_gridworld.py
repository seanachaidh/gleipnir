...
class TestGridWorldClass(unittest.TestCase):
    def setUp(self):
        self.grid = gleipnir.GridworldGame(9, 3, 3, 8)
        #Greed does appearantly pay in this game
        #~ self.grid.add_players(gleipnir.PHCPlayer(4, 9, 4), gleipnir.PHCPlayer(4, 9, 0))

        self.grid.add_players(gleipnir.WolfPlayer(4, 9, 4, 0.01, 0.0, 0.035, 0.07), gleipnir.WolfPlayer(4, 9, 0, 0.01, 0.0, 0.5, 0.9))
    ...
    def test_gameplaying(self):
        ...
        for i in range(1000):
            ...
            self.grid.player1.state = 4
            self.grid.player2.state = 0
